...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>/asset/admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    ...
    <!-- CodeMirror -->
  <link rel="stylesheet" href="<?= base_url(); ?>/asset/admin/plugins/codemirror/codemirror.css">
  <link rel="stylesheet" href="<?= base_url(); ?>/asset/admin/plugins/codemirror/theme/monokai.css">
  <!-- SimpleMDE -->
  <link rel="stylesheet" href="<?= base_url(); ?>/asset/admin/plugins/simplemde/simplemde.min.css">
